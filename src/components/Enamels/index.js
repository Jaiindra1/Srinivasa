...
class EnamelsBilling extends Component {
    state = {
        searchInput: "",
        data: [],
        filteredData: [],
    ...
    handleAddToReceipt = () => {
        ...
        localStorage.setItem('Enamels_Data', JSON.stringify({ todoList, total }));
    
        // Reset the emulsions page state
        this.setState({
            todoList: [],
            searchInput: "",
            selectedBase: "",
    ...
    render() {
        const { searchInput, filteredData, showDropdown, baseOptions, selectedBase, selectedLiters, todoList, showReceipt } = this.state;
        const navigate = this.props.navigate;
        return (
            <div className="container">
                <h1 className="heading">Enamels</h1>
...
export default function EnamelsBillingWrapper(props) {
    const navigate = useNavigate();
    return <EnamelsBilling {...props} navigate={navigate} />;
}
