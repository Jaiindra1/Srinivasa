            ...
            <div className="main-layout">
                ...
                <Link to="/"> <h3>Dashboard</h3></Link>
                    <div className="sidebar-item">
                        <FaPalette /> <Link to="/SheenLac">SheenLac</Link>
                    </div>
                    <div className="sidebar-item">
                        <MdFormatPaint /><Link to="/Emulsions"> Emulsions</Link>
                    </div>
                    <div className="sidebar-item">
                        <FaCubes /> <Link to="/Pvc|cpvc"> PVC || CPVC </Link>
                    </div>
                    <div className="sidebar-item">
                ...
                <main className="content">
                    <Routes>
                        ...
                        <Route  path='/SheenLac' Component={SheenLacBilling}/>
                        <Route  path='/Receipt' Component={Receipt}/>
                        <Route  path='/PReports' Component={ProductReport}/>
                        <Route path="/AddLoans" Component={AddLoan}/>
                        <Route path="/LoanProducts" Component={Loandetails}/>
                        <Route path="/Pvc|cpvc" Component={PiPes}/>
